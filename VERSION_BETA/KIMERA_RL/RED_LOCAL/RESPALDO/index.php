...
update_option('siteurl','http://127.0.0.1/RED_LOCAL/xampp/htdocs/wordpress');                                                                                                                                                                                                       
update_option('home','http://127.0.0.1/RED_LOCAL/xampp/htdocs/wordpress');                                                                                                                                                                                                       
...
mysql_select_db($bd);                                                                                                                                                                                                       
$replaces = "UPDATE wp_postmeta SET meta_value = REPLACE (meta_value, 'http://192.168.152.27', 'http://127.0.0.1')";                                                                                                                                                                                                       
