...
$string['pluginadministration'] = 'Administración de LTI';
...
$string['registertype'] = 'Configura un nuevo registro de herramienta externa';
...
$string['share_roster_admin'] = 'La herramienta puede acceder a la lista de cursos';
$string['show_in_course'] = 'Mostrar el tipo de herramienta cuando se están creando instancias de la herramienta';
...
$string['toggle_debug_data'] = 'Activar información para desarrolladores';
