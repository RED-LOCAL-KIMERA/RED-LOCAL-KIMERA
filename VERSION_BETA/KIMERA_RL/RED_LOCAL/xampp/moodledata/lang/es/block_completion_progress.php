...
/**
 * Strings for component 'block_completion_progress', language 'es', branch 'MOODLE_29_STABLE'
 *
...
$string['config_orderby'] = 'Ordenar la barra por';
$string['config_orderby_course_order'] = 'Ordenación en curso';
$string['config_orderby_due_time'] = 'Tiempo usando "{$a}" fecha';
$string['config_percentage'] = 'Mostrar el porcentaje a los estudiantes';
$string['config_scroll'] = 'Desplazamiento';
$string['config_selectactivities'] = 'Seleccionar actividades';
$string['config_selectedactivities'] = 'Actividades seleccionadas';
$string['config_squeeze'] = 'Exprimir';
...
$string['showallinfo'] = 'Mostrar toda la info';
$string['showinactive'] = 'Mostrar estudiantes inactivos en la vista general';
...
$string['wrapafter'] = 'Al envolver, limitar las filas a';
