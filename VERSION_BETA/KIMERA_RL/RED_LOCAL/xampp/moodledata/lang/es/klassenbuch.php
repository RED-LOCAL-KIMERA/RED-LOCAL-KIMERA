...
/**
 * Strings for component 'klassenbuch', language 'es', branch 'MOODLE_29_STABLE'
 *
 * @package   klassenbuch
...
$string['numbering_help'] = '* Ninguno - los títulos de capítulo y subcapítulo no tienen ningún tipo de formato, utilícelo si quiere definir estilos de numeración especiales. Por ejemplo letras: en el título del capítulo escriba "A Primer capítulo", "A.1 Algún Subcapítulo",...
* Números - los capítulos y subcapítulos están numerados (1, 1.1, 1.2, 2, ...)
* Viñetas - los subcapítulos tienen sangría y se indican con viñetas
* Sangría - los subcapítulos tienen sangría';
$string['numberingoptions'] = 'Opciones de numeración disponibles';
$string['numberingoptions_help'] = 'Seleccione las opciones de numeración que deberían estar disponibles cuando se creen nuevos libros.';
