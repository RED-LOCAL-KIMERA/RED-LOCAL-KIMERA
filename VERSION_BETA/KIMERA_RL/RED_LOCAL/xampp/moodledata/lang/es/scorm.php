...
$string['tracktype_help'] = 'Tipo de pregunta, por ejemplo "elección" o "respuesta corta".';
...
$string['updatefreq_error'] = 'La frecuencia de auto-actualización únicamente puede ser establecida cuando el paquete está ubicado en un servidor externo';
