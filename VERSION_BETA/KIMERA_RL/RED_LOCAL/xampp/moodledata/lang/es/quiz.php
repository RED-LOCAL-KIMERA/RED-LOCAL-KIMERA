...
$string['eventeditpageviewed'] = 'Página de edición del cuestionario vista';
...
$string['manualgradequestion'] = 'Calificación manual en la pregunta {$a->question} por {$a->user}';
...
$string['max'] = 'Máx';
$string['maxmark'] = 'Máxima puntuación';
