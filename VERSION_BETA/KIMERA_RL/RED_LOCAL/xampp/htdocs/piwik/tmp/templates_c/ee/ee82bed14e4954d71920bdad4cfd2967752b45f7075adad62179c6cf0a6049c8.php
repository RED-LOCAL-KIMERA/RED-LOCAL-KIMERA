...
class __TwigTemplate_e6f1cf2fcae7358a83f2ded14bdc76a5cb9623cbf885095fe95e81edd00363db extends Twig_Template
{
...
";
        ...
        ";
            ...
            if ($this->getAttribute($context["visitor"], "truncatedActionsCount", array(), "any", true, true)) {
                // line 32
                echo "                        ";
                $context["actionCount"] = ((isset($context["actionCount"]) ? $context["actionCount"] : $this->getContext($context, "actionCount")) + $this->getAttribute($context["visitor"], "truncatedActionsCount", array()));
                // line 33
                echo "                    ";
            }
            // line 34
            ...
            echo "
                    ";
            // line 35
            if (((isset($context["actionCount"]) ? $context["actionCount"] : $this->getContext($context, "actionCount")) <= 1)) {
                // line 36
                echo "                        ";
...
{% for visitor in dataTable.getRows() %}
    ...
    {{ visitorRow }}
{% endfor %}
", "@Live/_dataTableViz_visitorLog.twig", "C:\\KIMERA_RL\\RED_LOCAL\\xampp\\htdocs\\piwik\\plugins\\Live\\templates\\_dataTableViz_visitorLog.twig");
    }
}
