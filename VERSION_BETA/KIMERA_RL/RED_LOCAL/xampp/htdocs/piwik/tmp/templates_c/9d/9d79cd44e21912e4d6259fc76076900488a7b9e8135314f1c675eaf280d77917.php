...
class __TwigTemplate_0ac8132082e69a2fc5fd11755e393b64906019a77f8a91889f79e857a09e384b extends Twig_Template
{
    ...
    <div>
        ...
        <div class=\"visitor-profile-visit-details\">
            ...
            if ($this->getAttribute($context["visitInfo"], "truncatedActionsCount", array(), "any", true, true)) {
                // line 19
                echo "                    ";
                $context["actionCount"] = ((isset($context["actionCount"]) ? $context["actionCount"] : $this->getContext($context, "actionCount")) + $this->getAttribute($context["visitInfo"], "truncatedActionsCount", array()));
                // line 20
                echo "                ";
            }
            // line 21
            ...
            if (($this->getAttribute($context["visitInfo"], "getColumn", array(0 => "visitDuration"), "method") != 0)) {
                // line 22
                echo "                    ";
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Live_ActionsAndDuration", (isset($context["actionCount"]) ? $context["actionCount"] : $this->getContext($context, "actionCount")), $this->getAttribute($context["visitInfo"], "getColumn", array(0 => "visitDurationPretty"), "method"))), "html", null, true);
                echo "
                ";
            } else {
                // line 24
                echo "                    ";
                echo \Piwik\piwik_escape_filter($this->env, (isset($context["actionCount"]) ? $context["actionCount"] : $this->getContext($context, "actionCount")), "html", null, true);
                echo " ";
...
{% endfor %}", "@Live/getVisitList.twig", "C:\\KIMERA_RL\\RED_LOCAL\\xampp\\htdocs\\piwik\\plugins\\Live\\templates\\getVisitList.twig");
    }
}
