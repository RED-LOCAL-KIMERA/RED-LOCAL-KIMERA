...
class __TwigTemplate_4a9727a86180df8f35dec6815f8b4ecd99dc884908bea956db8ab16c4a7b0176 extends Twig_Template
{
    ...
    ";
        // line 2
        if (((isset($context["numFailures"]) ? $context["numFailures"] : $this->getContext($context, "numFailures")) == 0)) {
            // line 3
    ...
    ";
            ...
            // line 6
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("CoreAdminHome_NTrackingFailures", (isset($context["numFailures"]) ? $context["numFailures"] : $this->getContext($context, "numFailures")))), "html", null, true);
            echo "</span>
        </p>
        <p>
            <a href=\"";
    ...
    {% endif %}
</div>", "@CoreAdminHome/getTrackingFailures.twig", "C:\\KIMERA_RL\\RED_LOCAL\\xampp\\htdocs\\piwik\\plugins\\CoreAdminHome\\templates\\getTrackingFailures.twig");
    }
}
