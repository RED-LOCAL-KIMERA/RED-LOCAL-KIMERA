...
class __TwigTemplate_79db067d150b1c1cbb88059851ca5d61e2c93f092b6622abecb369db2b16011d extends Twig_Template
{
...
<html id=\"ng-app\" ";
    ...
    <body id=\"";
        // line 33
        echo \Piwik\piwik_escape_filter($this->env, (((isset($context["bodyId"]) || array_key_exists("bodyId", $context))) ? (_twig_default_filter((isset($context["bodyId"]) ? $context["bodyId"] : $this->getContext($context, "bodyId")), "")) : ("")), "html", null, true);
        echo "\" ng-app=\"app\" class=\"";
        echo \Piwik\piwik_escape_filter($this->env, (((isset($context["bodyClass"]) || array_key_exists("bodyClass", $context))) ? (_twig_default_filter((isset($context["bodyClass"]) ? $context["bodyClass"] : $this->getContext($context, "bodyClass")), "")) : ("")), "html", null, true);
        echo "\">
...
", "@Morpheus/layout.twig", "C:\\KIMERA_RL\\RED_LOCAL\\xampp\\htdocs\\piwik\\plugins\\Morpheus\\templates\\layout.twig");
    }
}
