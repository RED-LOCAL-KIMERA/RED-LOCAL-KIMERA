...
class __TwigTemplate_d5bb077421d33d6526667cc16d2878dc94818fd6273d0868f81001d744c370ac extends Twig_Template
{
...
(isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "count", array()) == 1)) {
                echo "title=\"";
                echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Annotations_AnnotationOnDate", (isset($context["date"]) ? $context["date"] : $this->getContext($context, "date")), \Piwik\piwik_escape_filter($this->env, $this->getAttribute(                // line 8
(isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "note", array()), "html_attr")));
                echo "
";
                // line 9
...
", "@Annotations/getEvolutionIcons.twig", "C:\\KIMERA_RL\\RED_LOCAL\\xampp\\htdocs\\piwik\\plugins\\Annotations\\templates\\getEvolutionIcons.twig");
    }
}
