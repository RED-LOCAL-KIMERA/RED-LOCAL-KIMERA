...
class __TwigTemplate_857a6be2297119fb9a4656c0510a026e31b40f5ad1da9976f6b10acd008c0137 extends Twig_Template
{
...
<div piwik-content-block
    ...
    <div id=\"js-code-options\" ng-controller=\"JsTrackingCodeController as jsTrackingCode\">
        ...
        echo "\"
                 title=\"";
        // line 70
        echo \Piwik\piwik_escape_filter($this->env, (call_user_func_array($this->env->getFilter('translate')->getCallable(), array("CoreAdminHome_JSTracking_MergeSubdomains")) . " <span class='current-site-name'></span>"), "html_attr");
        echo "\"
        ...
        echo "
            ...
            <div piwik-field uicontrol=\"checkbox\" name=\"javascript-tracking-all-aliases\"
                 ...
                 title=\"";
        // line 96
        echo \Piwik\piwik_escape_filter($this->env, (call_user_func_array($this->env->getFilter('translate')->getCallable(), array("CoreAdminHome_JSTracking_MergeAliases")) . " <span class='current-site-name'></span>"), "html_attr");
        echo "\"
...
{% endblock %}
", "@CoreAdminHome/trackingCodeGenerator.twig", "C:\\KIMERA_RL\\RED_LOCAL\\xampp\\htdocs\\piwik\\plugins\\CoreAdminHome\\templates\\trackingCodeGenerator.twig");
    }
}
