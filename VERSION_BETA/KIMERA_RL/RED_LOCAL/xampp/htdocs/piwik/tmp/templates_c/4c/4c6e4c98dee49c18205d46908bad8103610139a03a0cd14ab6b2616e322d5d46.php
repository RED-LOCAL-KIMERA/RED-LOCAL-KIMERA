...
class __TwigTemplate_387587c37b85619d2a979db3c20833040ac5c1a71a12af4722551e0740f6764a extends Twig_Template
{
    ...
    ";
        ...
        <p>
            ";
            // line 26
            echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Installation_ProfessionalServicesfessionalDiscoverHow", (("<a rel=\"noreferrer noopener\" target=\"_blank\" href=\"" . (isset($context["linkToProfessionalServices"]) ? $context["linkToProfessionalServices"] : $this->getContext($context, "linkToProfessionalServices"))) . "\">"), "</a>"));
            echo "
        </p>
    ";
        }
...
{% endblock %}
", "@Installation/finished.twig", "C:\\KIMERA_RL\\RED_LOCAL\\xampp\\htdocs\\piwik\\plugins\\Installation\\templates\\finished.twig");
    }
}
