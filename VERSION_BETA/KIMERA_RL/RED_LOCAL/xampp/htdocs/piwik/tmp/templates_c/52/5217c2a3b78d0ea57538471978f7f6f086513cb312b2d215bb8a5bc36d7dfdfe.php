...
class __TwigTemplate_fdfa221081ee54e4347eb8755a1a41612f812f384d49d0d6481c01a6cd94576f extends Twig_Template
{
...
$context["entry"], "cities", array(), "any", true, true) && (1 < twig_length_filter($this->env, $this->getAttribute($context["entry"], "cities", array()))))) {
        ...
        if (twig_test_empty((((isset($context["userCountryMapUrl"]) || array_key_exists("userCountryMapUrl", $context))) ? (_twig_default_filter((isset($context["userCountryMapUrl"]) ? $context["userCountryMapUrl"] : $this->getContext($context, "userCountryMapUrl")), "")) : ("")))) {
    ...
    <div class=\"visitor-profile-map\" style=\"display:none\" data-href=\"";
        // line 38
        echo \Piwik\piwik_escape_filter($this->env, (((isset($context["userCountryMapUrl"]) || array_key_exists("userCountryMapUrl", $context))) ? (_twig_default_filter((isset($context["userCountryMapUrl"]) ? $context["userCountryMapUrl"] : $this->getContext($context, "userCountryMapUrl")), "")) : ("")), "html", null, true);
        echo "\">
    </div>
</div>";
    }
...
</div>", "@UserCountry/_profileSummary.twig", "C:\\KIMERA_RL\\RED_LOCAL\\xampp\\htdocs\\piwik\\plugins\\UserCountry\\templates\\_profileSummary.twig");
    }
}
