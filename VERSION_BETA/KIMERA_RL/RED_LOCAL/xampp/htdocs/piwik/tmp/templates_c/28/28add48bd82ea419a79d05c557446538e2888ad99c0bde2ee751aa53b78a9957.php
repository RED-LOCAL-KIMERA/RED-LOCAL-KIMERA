...
/* macros.twig */
class __TwigTemplate_0c2ff141dd84154cdfb87f0f4d438a0ab73a896da7c8963c0d6f9062c88b1306 extends Twig_Template
{
    ...
    public function getlogoHtml($__metadata__ = null, $__alt__ = "", ...$__varargs__)
    {
        ...
        try {
            ...
            if ($this->getAttribute((isset($context["metadata"]) ? $context["metadata"] : null), "logo", array(), "array", true, true)) {
                ...
                echo \Piwik\piwik_escape_filter($this->env, (isset($context["alt"]) ? $context["alt"] : $this->getContext($context, "alt")), "html", null, true);
                echo " ";
                echo \Piwik\piwik_escape_filter($this->env, (((isset($context["width"]) || array_key_exists("width", $context))) ? (_twig_default_filter((isset($context["width"]) ? $context["width"] : $this->getContext($context, "width")), "")) : ("")), "html", null, true);
                echo " ";
                echo \Piwik\piwik_escape_filter($this->env, (((isset($context["height"]) || array_key_exists("height", $context))) ? (_twig_default_filter((isset($context["height"]) ? $context["height"] : $this->getContext($context, "height")), "")) : ("")), "html", null, true);
                echo " src='";
...
{% endmacro %}", "macros.twig", "C:\\KIMERA_RL\\RED_LOCAL\\xampp\\htdocs\\piwik\\plugins\\Morpheus\\templates\\macros.twig");
    }
}
