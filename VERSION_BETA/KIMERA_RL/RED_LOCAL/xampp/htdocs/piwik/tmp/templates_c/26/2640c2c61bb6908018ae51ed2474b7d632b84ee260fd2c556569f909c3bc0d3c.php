...
class __TwigTemplate_26f39621eb84fab90f740eb610487236de117d948aa70ae30fe1e5b493ec7268 extends Twig_Template
{
    ...
    {
        // line 2
        if ((((isset($context["isValidHost"]) || array_key_exists("isValidHost", $context)) && (isset($context["invalidHostMessage"]) || array_key_exists("invalidHostMessage", $context))) && ((isset($context["isValidHost"]) ? $context["isValidHost"] : $this->getContext($context, "isValidHost")) == false))) {
            // line 3
            echo "    ";
            ob_start();
            // line 4
...
", "@CoreHome/_warningInvalidHost.twig", "C:\\KIMERA_RL\\RED_LOCAL\\xampp\\htdocs\\piwik\\plugins\\CoreHome\\templates\\_warningInvalidHost.twig");
    }
}
