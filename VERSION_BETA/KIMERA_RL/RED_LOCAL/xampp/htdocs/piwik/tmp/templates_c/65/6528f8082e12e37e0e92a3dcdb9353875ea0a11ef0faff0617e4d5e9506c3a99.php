...
class __TwigTemplate_f546d0582d061592eb0fed79fd4d165c125ed63b365e3116a1db2abbd41343dd extends Twig_Template
{
...
";
        ...
        <div class=\"visitor-profile-info\">
            ...
            if (twig_test_empty($this->getAttribute((isset($context["visitorData"]) ? $context["visitorData"] : $this->getContext($context, "visitorData")), "userId", array()))) {
                ...
                echo ": ";
                echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), array($this->getAttribute((isset($context["visitorData"]) ? $context["visitorData"] : $this->getContext($context, "visitorData")), "userId", array())));
                echo "\">";
                echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), array($this->getAttribute((isset($context["visitorData"]) ? $context["visitorData"] : $this->getContext($context, "visitorData")), "userId", array())));
                echo "</span>
                                ";
            ...
            if ((isset($context["widgetizedLink"]) || array_key_exists("widgetizedLink", $context))) {
                ...
                echo \Piwik\piwik_escape_filter($this->env, twig_upper_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("General_Id"))), "html", null, true);
                echo " ";
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitorData"]) ? $context["visitorData"] : $this->getContext($context, "visitorData")), "visitorId", array()), "html", null, true);
                echo "\">";
            }
            // line 49
            echo "                                    <span>";
            ...
            echo "\">
                            ...
                            ";
            // line 56
            echo call_user_func_array($this->env->getFunction('postEvent')->getCallable(), array("Live.renderVisitorIcons", twig_first($this->env, $this->getAttribute((isset($context["visitorData"]) ? $context["visitorData"] : $this->getContext($context, "visitorData")), "lastVisits", array()))));
            echo "
                        </div>
                    </div>
                </div>
                ...
                ";
            // line 61
            echo (isset($context["profileSummary"]) ? $context["profileSummary"] : $this->getContext($context, "profileSummary"));
            echo "
            ...
            <div class=\"visitor-profile-visits-info\">
                <div class=\"visitor-profile-visits-container\">
                    <ol class=\"visitor-profile-visits\">
                        ";
            // line 68
            $this->loadTemplate("@Live/getVisitList.twig", "@Live/getVisitorProfilePopup.twig", 68)->display(array_merge($context, array("visits" => $this->getAttribute((isset($context["visitorData"]) ? $context["visitorData"] : $this->getContext($context, "visitorData")), "lastVisits", array()), "startCounter" => $this->getAttribute((isset($context["visitorData"]) ? $context["visitorData"] : $this->getContext($context, "visitorData")), "totalVisits", array()))));
            // line 69
            echo "                    </ol>
                </div>
            ...
            if (($this->getAttribute($this->getAttribute((isset($context["visitorData"]) ? $context["visitorData"] : $this->getContext($context, "visitorData")), "lastVisits", array()), "getRowsCount", array(), "method") >= twig_constant("Piwik\\Plugins\\Live\\VisitorProfile::VISITOR_PROFILE_MAX_VISITS_TO_SHOW"))) {
                ...
                if ($this->getAttribute((isset($context["visitorData"]) ? $context["visitorData"] : $this->getContext($context, "visitorData")), "hasMoreVisits", array())) {
                    // line 79
                    echo "                                ";
                    echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Live_LimitedVisitsShown", (("<strong>" . $this->getAttribute((isset($context["visitorData"]) ? $context["visitorData"] : $this->getContext($context, "visitorData")), "totalVisits", array())) . "</strong>")));
                    echo "
                            ";
                } else {
                    // line 81
...
";
    ...
    {
        return array (  226 => 85,  222 => 83,  216 => 81,  210 => 79,  208 => 78,  205 => 77,  197 => 73,  195 => 72,  190 => 69,  188 => 68,  180 => 63,  175 => 61,  167 => 56,  160 => 52,  155 => 51,  151 => 50,  147 => 49,  137 => 48,  133 => 47,  129 => 46,  125 => 45,  120 => 42,  115 => 40,  110 => 38,  107 => 37,  97 => 35,  93 => 33,  91 => 32,  89 => 31,  84 => 29,  79 => 27,  72 => 23,  68 => 22,  64 => 21,  55 => 15,  50 => 13,  44 => 10,  38 => 7,  34 => 6,  30 => 5,  27 => 4,  21 => 2,  19 => 1,);
    }
...
{% endif %}", "@Live/getVisitorProfilePopup.twig", "C:\\KIMERA_RL\\RED_LOCAL\\xampp\\htdocs\\piwik\\plugins\\Live\\templates\\getVisitorProfilePopup.twig");
    }
}
