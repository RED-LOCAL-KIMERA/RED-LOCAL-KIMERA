...
class __TwigTemplate_9c8ec6256f9032c002ea13da3b2fa3e4bcb7874130d61c3b0d1799b167e3297c extends Twig_Template
{
...
(isset($context["idSubtable"]) || array_key_exists("idSubtable", $context))) ? (_twig_default_filter((isset($context["idSubtable"]) ? $context["idSubtable"] : $this->getContext($context, "idSubtable")), false)) : (false)));
        // line 5
...
";
        ...
        <tbody>";
            ...
            if (((isset($context["showingEmbeddedSubtable"]) ? $context["showingEmbeddedSubtable"] : $this->getContext($context, "showingEmbeddedSubtable")) && ($this->getAttribute((isset($context["dataTable"]) ? $context["dataTable"] : $this->getContext($context, "dataTable")), "getRowsCount", array(), "method") == 0))) {
                // line 15
                echo "            ";
                if ((( !(isset($context["clientSideParameters"]) || array_key_exists("clientSideParameters", $context)) ||  !$this->getAttribute((isset($context["clientSideParameters"]) ? $context["clientSideParameters"] : null), "filter_pattern_recursive", array(), "any", true, true)) ||  !$this->getAttribute((isset($context["clientSideParameters"]) ? $context["clientSideParameters"] : $this->getContext($context, "clientSideParameters")), "filter_pattern_recursive", array()))) {
                    // line 16
...
(isset($context["properties"]) ? $context["properties"] : null), "replace_row_with_subtable", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["properties"]) ? $context["properties"] : null), "replace_row_with_subtable", array()), false)) : (false)));
                ...
                $context = array_intersect_key($context, $_parent) + $_parent;
                // line 53
                if (($this->getAttribute((isset($context["dataTable"]) ? $context["dataTable"] : $this->getContext($context, "dataTable")), "getTotalsRow", array()) && $this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_totals_row", array()))) {
                    // line 54
                    echo "                ";
                    $context["row"] = $this->getAttribute((isset($context["dataTable"]) ? $context["dataTable"] : $this->getContext($context, "dataTable")), "getTotalsRow", array());
                    // line 55
                    echo "                ";
                    $context["rowId"] = "totalsRow";
                    // line 56
                    echo "                <tr class=\"";
                    echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["row"]) ? $context["row"] : $this->getContext($context, "row")), "getMetadata", array(0 => "css_class"), "method"), "html", null, true);
                    echo " totalsRow\"
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                        ...
                        echo "                        <td>
                            ";
                        // line 60
                        $this->loadTemplate("@CoreHome/_dataTableCell.twig", "@CoreVisualizations/_dataTableViz_htmlTable.twig", 60)->display(array_merge($context, (isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties"))));
                        // line 61
                        echo "                        </td>
                    ";
                        ++$context['loop']['index0'];
    ...
    {
        return array (  268 => 67,  266 => 66,  263 => 65,  259 => 63,  244 => 61,  242 => 60,  239 => 59,  222 => 58,  216 => 56,  213 => 55,  210 => 54,  208 => 53,  193 => 51,  190 => 50,  187 => 49,  184 => 47,  180 => 45,  165 => 43,  163 => 42,  160 => 41,  143 => 40,  135 => 39,  121 => 38,  116 => 37,  109 => 36,  102 => 35,  95 => 34,  93 => 33,  91 => 31,  90 => 30,  89 => 29,  88 => 28,  86 => 25,  84 => 24,  82 => 23,  80 => 22,  63 => 21,  60 => 20,  52 => 17,  49 => 16,  46 => 15,  44 => 14,  40 => 11,  38 => 10,  35 => 9,  33 => 8,  27 => 6,  25 => 5,  23 => 4,  22 => 3,  20 => 2,  19 => 1,);
    }
...
{% else %}
    ...
    {%- endif -%}
{% endif %}", "@CoreVisualizations/_dataTableViz_htmlTable.twig", "C:\\KIMERA_RL\\RED_LOCAL\\xampp\\htdocs\\piwik\\plugins\\CoreVisualizations\\templates\\_dataTableViz_htmlTable.twig");
    }
}
